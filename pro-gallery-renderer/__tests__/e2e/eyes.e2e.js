...
describe('Eyes layout tests', () => {
  ...
  it('Collage layout - Desktop', async () => {
    ...
    await expect(await driver.grab.screenshot()).toMatchScreenshot({
      key: 'Collage layout - Desktop',
      version: 'v1.0.1',
    });
  });
  ...
  it('Thumbnails 1 layout - Desktop', async () => {
    ...
    await expect(await driver.grab.screenshot()).toMatchScreenshot({
      key: 'Thumbnails 1 layout - Desktop',
      version: 'v1.0.1',
    });
  });
  ...
  it('Thumbnails 2 layout - Desktop', async () => {
    ...
    await expect(await driver.grab.screenshot()).toMatchScreenshot({
      key: 'Thumbnails 2 layout - Desktop',
      version: 'v1.0.1',
    });
  });
  ...
  it('Thumbnails 1 layout - Android', async () => {
    ...
    await expect(await driver.grab.screenshot()).toMatchScreenshot({
      key: 'Thumbnails 1 layout - Android',
      version: 'v1.0.1',
    });
  });
  ...
  it('Thumbnails 2 layout - iPhone', async () => {
    ...
    await expect(await driver.grab.screenshot()).toMatchScreenshot({
      key: 'Thumbnails 2 layout - iPhone',
      version: 'v1.0.1',
    });
  });
  ...
  it('Column layout - iPhone', async () => {
    ...
    await driver.waitFor.timer(1000);
    await expect(await driver.grab.screenshot()).toMatchScreenshot({
      key: 'Column layout after a click right',
      version: 'v1.0.1',
    });
  });
});
