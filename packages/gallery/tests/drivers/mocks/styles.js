...
const options = {
  ...
  [optionsMap.layoutParams.thumbnails.alignment]: GALLERY_CONSTS[optionsMap.layoutParams.thumbnails.alignment].BOTTOM,
  [optionsMap.layoutParams.structure.groupsOrder]:
    GALLERY_CONSTS[optionsMap.layoutParams.structure.groupsOrder].BY_HEIGHT,
  [optionsMap.layoutParams.groups.allowedGroupTypes]: ['1', '2h', '2v', '3t', '3b', '3l', '3r'],
  ...
  [optionsMap.behaviourParams.gallery.horizontal.slideTransition]:
    GALLERY_CONSTS[optionsMap.behaviourParams.gallery.horizontal.slideTransition].EASE,
  ...
  [optionsMap.behaviourParams.gallery.horizontal.slideshowInfo.enableCounter]: false,
  [optionsMap.behaviourParams.gallery.horizontal.slideshowInfo.enablePlayButton]: false,
