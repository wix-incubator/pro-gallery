...
describe('options - behaviourParams_item_overlay_size', () => {
  let driver;
  let initialProps;
  ...
  it('should set the correct behaviourParams_item_overlay_size of 50 - right position', async () => {
    initialProps.options = Object.assign(initialProps.options, {
  ...
  it('should set the correct behaviourParams_item_overlay_size of "50" - position top ', async () => {
    initialProps.options = Object.assign(initialProps.options, {
      [optionsMap.behaviourParams.item.overlay.position]:
