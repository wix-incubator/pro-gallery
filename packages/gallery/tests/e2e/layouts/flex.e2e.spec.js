...
describe('flex - e2e', () => {
  ...
  it('flex - layoutParams_structure_scrollDirection = VERTICAL', async () => {
  ...
  it('flex - layoutParams_structure_scrollDirection = HORIZONTAL', async () => {
    await driver.navigate({
      [optionsMap.layoutParams.structure.galleryLayout]:
        GALLERY_CONSTS[optionsMap.layoutParams.structure.galleryLayout].FLEX,
      [optionsMap.layoutParams.structure.scrollDirection]:
  ...
  it('flex - with uniform dimensions enabled', async () => {
    await driver.navigate({
      [optionsMap.layoutParams.structure.galleryLayout]:
        GALLERY_CONSTS[optionsMap.layoutParams.structure.galleryLayout].FLEX,
  ...
  it('flex - with uniform dimensions disabled (should behave like masonry)', async () => {
    await driver.navigate({
      [optionsMap.layoutParams.structure.galleryLayout]:
        GALLERY_CONSTS[optionsMap.layoutParams.structure.galleryLayout].FLEX,
