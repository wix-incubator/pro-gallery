...
export default {
  ...
  isRelevant: (sp) =>
    sp.scrollDirection === GALLERY_CONSTS.scrollDirection.VERTICAL && //NEW STYPEPARAMS METHOD check that this is a true isRelevant... why is it only in vertical galleries
    sp.gridStyle !== 1,
