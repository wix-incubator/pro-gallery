...
export const nameChangedBehaviourParams = [
  ...
  ['scrollAnimationReset', optionsMap.behaviourParams.gallery.scrollAnimationReset],
  ['jsonScrollAnimation', optionsMap.behaviourParams.gallery.jsonScrollAnimation],
  ['infiniteScrollAnimation', optionsMap.behaviourParams.gallery.infiniteScrollAnimation],
