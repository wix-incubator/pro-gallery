...
import behaviourParams_gallery_scrollAnimationProperties from './behaviourParams_gallery_scrollAnimationProperties';
...
export default {
  ...
  behaviourParams_gallery_scrollAnimationProperties,
