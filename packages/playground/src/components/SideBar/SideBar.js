      ...
      <Collapse accordion={true} bordered={true} defaultActiveKey={[]} onChange={() => { }}>
        ...
        <Collapse.Panel header="Simulators" key="simulators">
          <Form labelCol={{ span: 17 }} wrapperCol={{ span: 3 }}>
            ...
            <Form.Item label="Use External Custom Navigation Panel" labelAlign="left">
              <Switch checked={!!gallerySettings.useExternalCustomNavigationPanel} onChange={e => setGallerySettings({ useExternalCustomNavigationPanel: e })} />
            </Form.Item>
