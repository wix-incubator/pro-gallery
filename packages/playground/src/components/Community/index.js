  ...
  return (
    <div>
      ...
      <section>
        ...
        <Modal
          title="Submit your layout to the community"
          visible={showModal}
          onOk={() => {
            save({
          ...
          <Form layout="vertical">
            <Form.Item label="Title" labelAlign="left">
              <Input
                ...
                onChange={(e) => set_layoutItem({ ...layoutItem, title: e.target.value })}
              />
            </Form.Item>
            <Form.Item label="Description" labelAlign="left" help="describe your layout">
              <Input.TextArea
                value={layoutItem.description}
                onChange={(e) => set_layoutItem({ ...layoutItem, description: e.target.value })}
              />
            </Form.Item>
            <Form.Item
              label="Tags"
